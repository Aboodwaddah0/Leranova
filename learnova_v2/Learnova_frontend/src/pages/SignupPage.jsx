...
export default function SignupPage() {
  ...
  return (
    <main className={`min-h-screen bg-[#f7f9fb] px-4 py-8 ${isArabic ? "lang-ar" : "lang-en"}`}>
      ...
      <div className="mx-auto grid max-w-6xl overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_18px_56px_-26px_rgba(16,20,26,0.55)] lg:grid-cols-[1.25fr_0.75fr]">
