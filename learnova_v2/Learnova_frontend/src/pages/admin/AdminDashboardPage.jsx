...
export default function AdminDashboardPage() {
  ...
  return (
    <main className={`min-h-screen bg-[#f7f9fb] px-4 py-6 ${isArabic ? "lang-ar" : "lang-en"}`}>
      <button
        type="button"
        onClick={toggleLang}
      ...
      <div className="mx-auto grid min-h-[92vh] w-full max-w-7xl gap-6 lg:grid-cols-[260px_1fr]">
        <AdminSidebar />
